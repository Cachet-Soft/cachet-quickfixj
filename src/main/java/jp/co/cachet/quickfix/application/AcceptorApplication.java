...
public class AcceptorApplication extends MessageCracker implements quickfix.Application {
	private static final Logger log = LoggerFactory.getLogger(AcceptorApplication.class);
